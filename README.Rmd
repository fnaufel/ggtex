...
1. Download the file [`ggtex.py`](https://cdn.jsdelivr.net/gh/fnaufel/ggtex/ggtex.py) and save it somewhere, preferably in `~/bin`.
...
1. Download the file [`ggtex.py`](https://cdn.jsdelivr.net/gh/fnaufel/ggtex/ggtex.py) and save it somewhere.
